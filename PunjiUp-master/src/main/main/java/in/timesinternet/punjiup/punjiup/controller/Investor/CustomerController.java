...
public class CustomerController {
    ...
    ResponseEntity<Customer> showProfile(HttpServletRequest httpServletRequest)
    {
        String userEmail=(String)httpServletRequest.getAttribute("userEmail");
        return ResponseEntity.ok(customerServiceImp.showProfile(userEmail));
    ...
    @GetMapping("/customerfund")
    List<CustomerPositiondto> customerPositionDetail(HttpServletRequest httpServletRequest) {
        String userEmail=(String)httpServletRequest.getAttribute("userEmail");
       return customerServiceImp.customerPositionDetail(userEmail);

    }

    @PostMapping("/buycart")
    @PreAuthorize("hasRole('ROLE_INVESTOR')")
    ResponseEntity<List<Transaction>> buy(HttpServletRequest httpServletRequest){
        String userEmail=(String)httpServletRequest.getAttribute("userEmail");
        return ResponseEntity.ok(customerServiceImp.buyCart(userEmail));
    }
