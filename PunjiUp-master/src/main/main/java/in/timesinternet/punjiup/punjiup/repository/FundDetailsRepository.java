...
public interface FundDetailsRepository extends JpaRepository<FundDetails, Integer> {
  ...
  List<FundDetails> findAllByFundTypeOrderByPreferenceAsc(FundType fundType);
  List<FundDetails> findAllByFundNameContainingIgnoreCaseOrderByPreferenceAsc(String fundName);
