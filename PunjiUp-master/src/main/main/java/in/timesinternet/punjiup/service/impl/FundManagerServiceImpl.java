...
public class FundManagerServiceImpl implements FundManagerService {
    ...
    public FundManager UpdateManager(FundManagerUpdateDTO fundManagerUpdateDTO,String userEmail) {
        ...
        if(fundManagerOptional.isPresent())
        {
            ...
            return fundManagerRepository.saveAndFlush(fundManager);
        }
        else
        {
    ...
    @Override
    public Transaction updateTransactionStatus(TransactionUpdateManagerDTO transactionStatusUpdateDto) {
  ...
  @Override
   public List<Transaction> getAllTransaction(String userEmail)
    ...
    @Override
    public List<Transaction> getTransactionbyfund(Integer fundId, String userEmail) {
        Optional<FundManager> fundManagerOptional = fundManagerRepository.findByEmail(userEmail);
        Optional<FundDetails> fundDetailsOptional=fundDetailsRepository.findById(fundId);
